...
export const ResearchEconomics = () => {
  ...
  const fetchData = async (isFirstLoad = false) => {
    ...
    try {
      ...
      // Fetch research category breakdown directly
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white px-6 py-4 rounded-lg shadow-md flex items-center gap-3">
        ...
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Research Economics</h2>
          <p className="text-sm text-gray-500">Research segment financial performance and analysis</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h3 className="text-lg font-semibold mb-4 text-gray-900">Research Category Performance</h3>
      ...
      <div className="bg-gradient-to-r from-purple-50 to-indigo-50 p-6 rounded-lg border border-purple-200">
        <h3 className="text-lg font-semibold mb-3 text-gray-900">📊 Research Segment Insights</h3>
        <ul className="space-y-2 text-sm text-gray-700">
          ...
          <li>✅ Active Research Categories: <strong>{categoryData.length}</strong></li>
          {categoryData.length > 0 && (
            <li>✅ Top Category by Revenue: <strong>
              {categoryData.reduce((a, b) => a.revenue > b.revenue ? a : b).category}
            </strong></li>
          )}
        </ul>
      </div>
